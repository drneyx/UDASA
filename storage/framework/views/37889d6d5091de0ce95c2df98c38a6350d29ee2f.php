<div class="row" id="addNews">
    <div class="col-lg-12 mb-3">
        <div class="ibox-content">
            ...
            <hr>
            <form method="POST" enctype="multipart/form-data" action="<?php echo e(url('add-news')); ?>" id="form">
                <?php echo csrf_field(); ?>
                ...
                <div class=" col-md-12 mb-3">
                    ...
                    <textarea id="myBody" name="body" class="form-control myBody"><?php echo e(old('body')); ?></textarea>
                </div>
...
<?php /**PATH /home/udasa/public_html/resources/views/management/news/modals/news-modals/addNews.blade.php ENDPATH**/ ?>