    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 margin_bottom_50 update">
                <?php echo $__env->make('front-pages/homeComponents/chair_word', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
                    ...
                    <div class="col-md-4 service_blog margin_bottom_50 update">
                        <div class="full">
                            ...
                            <div class="service_cont">
                                <h3 class="service_head"><small><span class="new text-white pl-1 pr-1">New <i class="fa fa-star"></i></span></small> <?php echo e($news->title); ?></h3>
                                <div class="post_time">
                                    <p><i class="fa fa-clock-o"></i> <?php echo e(($news->date)->format('M d, Y')); ?> </p>
                                </div>
                                <p><?php echo e(substr($news->description, 0, 100)); ?> <?php echo e(strlen($news->description) > 100 ? '...' : ''); ?></p>
...
<?php /**PATH /home/udasa/public_html/resources/views/front-pages/homeComponents/updates.blade.php ENDPATH**/ ?>