<div id="create-album" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content animated bounceIn">
            ...
            <form action="<?php echo e(url('gallery/create-album')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label for="AlbumTitle">Album Name</label>
                            <input type="text" class="form-control" name="name" id="AlbumTitle" value="<?php echo e(old('title')); ?>" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label for="AlbumDescription">Short Description</label>
                            <textarea type="text" class="form-control" name="description" rows="5" id="AlbumDescription" value="<?php echo e(old('description')); ?>" required></textarea>
                        </div>
                    </div>
                    <!-- <div class="form-row">
                        <div class="form-group col-md-12">
...
</div><?php /**PATH /home/udasa/public_html/resources/views/gallery/albums/modals/create_album.blade.php ENDPATH**/ ?>