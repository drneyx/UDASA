                ...
                <div class="navbar-header" style="background-color: #2F4050;">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<?php echo e(url('assets/images/logo-icon.png')); ?>" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <div>
                                <img src="<?php echo e(url('assets/images/udsm.jpg')); ?>" alt="homepage" class="light-logo" style="width: 3rem; height: 3rem; object-fit:cover; border-radius: 50%;" />
                            </div>
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text --><span>
...
<?php /**PATH /home/udasa/public_html/resources/views/navigation-menu.blade.php ENDPATH**/ ?>