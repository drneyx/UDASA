                    ...
                    <div class="full">
                        <div class="title-holder">
                            <div class="title-holder-cell text-left">
                                <h1 class="page-title">Social Responsibilities</h1>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/udasa/public_html/resources/views/front-pages/activities/social_responsibilities.blade.php ENDPATH**/ ?>