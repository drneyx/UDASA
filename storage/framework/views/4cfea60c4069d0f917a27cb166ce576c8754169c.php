                    ...
                    <div class="full">
                        <div class="title-holder">
                            <div class="title-holder-cell text-left">
                                <h1 class="page-title">Current Leaders</h1>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="product_list">
                                    ...
                                    <div class="product_detail_btm">
                                        ...
                                        <div class="product_price">
                                            <p><span class="new_price"><?php echo e(strtoupper($leader->position)); ?> <?php echo e($leader->college != null ? '('. $leader->college->name .')' : ''); ?></span></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/udasa/public_html/resources/views/front-pages/leadership/current_leadership.blade.php ENDPATH**/ ?>