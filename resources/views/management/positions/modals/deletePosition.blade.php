<div id="del{{ $position->id }}" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content animated bounceIn">
            <div class="modal-header">
                <h4 class="modal-title">Delete Staff Position</h4>
                ...
                <div class="modal-body">
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <p>Are you sure to delete <span class="text-danger">{{$position->position}}</span> position?</p>
                        </div>
                    </div>
                </div>
