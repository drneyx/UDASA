<div id="edt{{ $position->id }}" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content animated bounceIn">
            <div class="modal-header">
                <h4 class="modal-title">Edit Staff Position</h4>
            ...
            <form action="{{ url('edit-position', $position->id) }}" method="POST">
                @csrf
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary waves-effect waves-light">Edit Position</button>
                </div>
            </form>
        </div>
    </div>
