<div class="row" id="addArticle">
    <div class="col-lg-12 mb-3">
            <div class="ibox-content">
                ...
                <hr>
                <form method="POST" enctype="multipart/form-data" action="{{ url('articles/add-article') }}" id="form">
                    @csrf
                    <div class="col-md-12 mb-3">
                        <h4 for="author_field">Author</h4>
                        <input type="text" class="form-control" name="author" id="author_field" list="author" value="{{ old('author') }}" required>
                    ...
                    <div class=" col-md-12 mb-3">
                        ...
                        <textarea id="myContents" name="contents" class="form-control myContents">{{ old('contents') }}</textarea>
                    </div>
