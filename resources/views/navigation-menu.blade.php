<nav x-data="{ open: false }" class="bg- white border-b border-g ray-100 navbar top-navbar navbar-expand-md navbar-dark" style="background-color: #029EEE;">
    <!-- Primary Navigation Menu -->
     <!-- ============================================================== -->
                <!-- Logo -->
                <!-- ============================================================== -->
                <div class="navbar-header" style="background-color: #2F4050;">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Light Logo icon -->
                            <div>
                                <img src="{{ url('assets/images/udsm.jpg') }}" alt="homepage" class="light-logo" style="width: 3rem; height: 3rem; object-fit:cover; border-radius: 50%;" />
                            </div>
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text --><span>
                         <span style="font-weight: bold;">UDSM</span>
                    </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
